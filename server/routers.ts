...
const propertiesRouter = router({
  ...
  create: protectedProcedure
    .input(z.object({
      ...
      lavabos: z.number().optional(),
      // Financeiro
      fireInsurance: z.number().optional(),
      ...
      condoUnits: z.number().optional(),
      condoAdministrator: z.string().optional(),
      builder: z.string().optional(),
      // Amenidades
      amenitiesUnit: z.array(z.string()).optional(),
      amenitiesCondo: z.array(z.string()).optional(),
      // Localização extra
      nearbySubway: z.boolean().optional(),
      subwayDistanceM: z.number().optional(),
      // SEO
